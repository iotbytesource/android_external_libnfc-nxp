...
//        HCI_DEBUG("HCI: Response Pending status --> FALSE, %s \n",  __FUNCTION__);
		HCI_DEBUG("HCI: Response Pending status --> FALSE, status(%d), %s \n", status, __FUNCTION__);		
...
//			HCI_DEBUG("HCI: Response Pending status --> FALSE, %s \n", __FUNCTION__);
			HCI_DEBUG("HCI: Response Pending status 1 --> FALSE, err(%d), %s \n", instruction, __FUNCTION__);
...
//    HCI_DEBUG("HCI: Response Pending status --> FALSE, %s \n", __FUNCTION__);
	HCI_DEBUG("HCI: Response Pending status 2 --> FALSE, instruction(%d), %s \n", instruction, __FUNCTION__);
