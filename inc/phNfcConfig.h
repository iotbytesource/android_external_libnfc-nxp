...
#ifdef CONFIG_SNFC
#define NXP_NFCIP_ACTIVE_DEFAULT        0x00U // Not supported (P2P Activie mode)
#else
...
#ifdef CONFIG_SNFC
#define DEFAULT_NFCIP_INITIATOR_MODE_SUPPORT   0x07U
#define DEFAULT_NFCIP_TARGET_MODE_SUPPORT      0x07U
#else
